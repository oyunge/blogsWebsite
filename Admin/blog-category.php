                                        ...
                                        <div class="col-lg-12">
                                            <form role="form" method="POST" action="includes/add-category.php">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="category-meta-table">
                                                </div>
                                                <div class="form-group">
                                                    <label>Category Path (lower case, no spaces)</label>
                                                    <input class="form-control" placeholder="Enter text" name="category-path">
                                                </div>
                                                ...
                                                <table class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        while ($rowCategories = mysqli_fetch_assoc($queryCategories)) {
                                                            ...
                                                            $metaTitle = $rowCategories['v_category_meta_table'];
